...
<head>
    ...
    <body onload="listarTransportistas(1);">
    	<div class="wrapper d-flex align-items-stretch celeste">
    		...
    		<div id="content"  >
    			...
    			<form name="form1" id="form1" method="post" action="javascript: listarTransportistas(1);">
    				
    				
    				<div class="row bg-white rounded p-2 pt-1  mx-5 mt-5  ">
    					<div class="col-lg-3">
    						<td>Nombre:</td>
    						<td><input class="form-control" name="criterio_usu_per" type="search" id="criterio_usu_per" placeholder="Nombre transportista" 
    							title="Ingrese un nombre para buscar" onKeyUp="javascript: listarTransportistas(1);"/></td>
    						</div>
    						<div class="col-lg-1">    
    							<td>Ordenar: </td>
    							<td>
    								<select class="form-select" name="criterio_ordenar_por" id="criterio_ordenar_por" onChange="javascript: listarTransportistas(1);">
    						...
    						<div class="col-lg-1">
    							<td>Registros: </td>
    							<td>
    								<select class="form-select" name="criterio_mostrar" id="criterio_mostrar" onChange="javascript: listarTransportistas(1);">
    						...
    						<div class="col-lg-2">
    							...
    							<select class="form-select" name="criterio_orden" id="criterio_orden" onChange="javascript: listarTransportistas(1);">
    						...
    						<div class="col-lg-1">
    							<a href="javascript: nuevochofer();" title="Agregar nuevo Transportista"><span type="button" class="btn btn-success">Nuevo</a>
    					...
    					<div id="listarTransportistas" class="mx-5  mt-3"></div>
