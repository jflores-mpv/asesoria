...
<head>
  ...
  <body onload="listarCierreCaja(1);">
   <div class="wrapper d-flex align-items-stretch celeste">
      ...
      <div id="content"  >
         ...
         <form name="form1" id="form1" method="post" action="javascript: listarCierreCaja(1);">
            ...
            <div class="row bg-white rounded p-2 pt-1  mx-5 mt-5  ">
             ...
             <div class="col-lg-2">
              <td>Fecha desde:</td>
              <td><input class="form-control" name="fecha_desde" type="text" id="fecha_desde" placeholder="fecha desde" onClick="displayCalendar(fecha_desde,'yyyy-mm-dd',this)"
                  onchange="javascript: listarCierreCaja(1);"/></td>
              </div>
              <div class="col-lg-2">
                  <td>Fecha hasta:</td>
                  <td><input class="form-control" name="fecha_hasta" type="text" id="fecha_hasta" placeholder="fecha hasta" onClick="displayCalendar(fecha_hasta,'yyyy-mm-dd',this)"
                      onchange="javascript: listarCierreCaja(1);"/></td>
                  </div>
                  ...
                  <div class="col-lg-1">    
                     <td>Ordenar: </td>
                     <td>
                        <select class="form-select" name="criterio_ordenar_por" id="criterio_ordenar_por" onChange="javascript: listarCierreCaja(1);">
               ...
               <div class="col-lg-1">
                 <td>Registros: </td>
                 <td>
                    <select class="form-select" name="criterio_mostrar" id="criterio_mostrar" onChange="javascript: listarCierreCaja(1);">
           ...
           <div class="col-lg-2">
             ...
             <select class="form-select" name="criterio_orden" id="criterio_orden" onChange="javascript: listarCierreCaja(1);">
...
<div id="listarCierreCaja" class="mx-5  mt-3"></div>
