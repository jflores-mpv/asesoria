...
<title>Registrar Cuenta Pagar</title>
...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Registrar Cuenta por Pagar</h4>
      </div>
      <div class="modal-body g-3">
        <form name="frmRegistrarCuentaPagar" id="frmRegistrarCuentaPagar" method="post" action="javascript: guardar_cuenta_pagar(6);" >
        ...
        <div class="row g-3 align-items-center">
          ...
          <div class="col-auto">
            ...
            <div class="row g-3 align-items-center mt-2">
              <div class="col-3">
                <label for="inputPassword6" class="col-form-label">Referencia/Cheque número:</label>
              </div>
              <div class="col-auto">
